export const App = () => {
    return (
        <section>
            ...
            <ul>
                <li>✔️ You can switch between the editor and preview using the buttons in the bottom-right corner.</li>
                <li>✔️ If you accidentally close a file, you can bring up the sidebar by clicking the navigation button at the top-left corner or by using a swipe motion.</li>
            </ul>
